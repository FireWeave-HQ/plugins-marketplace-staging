...
Run `rollout-server_ensure_auth` with
...
Then run the tool-manifest check via `rollout-server_list_registered_tools`.
...
| **2 — Choose agents**                  | Detect coding-agent markers (`.claude/`, `.cursor/`, …). Then one `the `question` tool` (multi-select) for **this** machine. **V1 full-materialize:** `cursor`, `claude` only. Other hosts are link-only experimental (optional second ask). Host detection alone is unreliable. Empty selection → re-ask once; if still empty → PARK (write nothing).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
