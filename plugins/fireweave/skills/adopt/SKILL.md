...
Then run the tool-manifest check via `mcp__rollout-server__list_registered_tools`.
...
| **2 — Choose agents**                  | Detect coding-agent markers (`.claude/`, `.cursor/`, …). Then one `AskUserQuestion` (multi-select) for **this** machine. **V1 full-materialize:** `cursor`, `claude` only. Other hosts are link-only experimental (optional second ask). Host detection alone is unreliable. Empty selection → re-ask once; if still empty → PARK (write nothing).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
